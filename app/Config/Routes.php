...
$routes->group('admin', ['namespace' => 'Modules\Admin\Controllers'], static function ($routes) {
    ...
    $routes->group('', ['filter' => 'adminauth:0,1,2,3,4,6'], static function ($routes) {
        ...
        $routes->get ('soal/teori/list',            'SoalTeoriController::index');        // fragment ?frag=list
        ...
        $routes->get('soal/teori/cari-kode',      'SoalTeoriController::searchKodeTeori');
        $routes->post('soal/teori/upload',        'SoalTeoriController::uploadMedia');
        ...
        // Soal Praktek
        $routes->get ('soal/praktek',                 'SoalPraktekController::index');
        $routes->get ('soal/praktek/list',            'SoalPraktekController::index');
        ...
        $routes->post('soal/praktek/upload',        'SoalPraktekController::upload');
        ...
        $routes->get('soal/praktek/review/(:num)',          'SoalPraktekController::review/$1');
        $routes->get('soal/praktek/review/history/(:num)',  'SoalPraktekController::revisiPrakHistory/$1');
        ...
        // Aspek
        $routes->get('praktek/aspek/list',   'SoalPraktekController::aspekList');
        $routes->post('praktek/aspek/delete','SoalPraktekController::aspekDelete');
        $routes->get('aspek/',           'Aspek::index');
        $routes->get('aspek/add/(:num)',         'Aspek::add/$1');
        ...
        $routes->get('osce-soal/table',           'OsceSoal::table');
        $routes->get('osce-soal/get/(:num)',      'OsceSoal::get/$1');
        $routes->post('osce-soal/create',         'OsceSoal::create');
        ...
        // Select2 options
        $routes->get('options/osce',    'OsceSoal::optionsOsce');
        $routes->get('options/soal',    'OsceSoal::optionsSoal');
